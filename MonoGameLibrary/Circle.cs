...
public readonly struct Circle: IEquatable<Circle>
{
    ...
    /// <remarks>
    /// The Empty property returns a reusable instance of an empty circle stored in the private static field s_empty.
    /// This is more efficient than creating new empty circles each time one is needed,
    /// as it reuses the same instance in memory.
    /// </remarks>
    /// </summary>
