...
public class GamePadInfo
{
    ...
    /// <summary>
    /// Stores the state of the Gamepad from the previous update cycle.
    /// </summary>
    public GamePadState PreviousState { get; private set; }
    
    /// <summary>
    /// Store the state of the gamepad for the current update cycle.
    /// </summary>
    public GamePadState CurrentState { get; private set; }

    /// <summary>
    /// Check to see if the current GamePad is connected.
    /// </summary>
    ...
    /// <summary>
    ///  Creates a new GamePadInfo for the gamepad connect at the specified player index.
    /// </summary>
